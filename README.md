...
* **🗺️ Level Progression System:** A level selection menu that tracks player progress and unlocks new stages.

* **🌍 Multi-Language Support:** Localization support (for English and Turkish) to adapt the game for a wider audience.

* **📱 Mobile-Friendly Interface:** Clean and scalable UI elements designed specifically for touch screens.
